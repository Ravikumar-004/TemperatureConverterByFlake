package com.health.temperatureconverterbyflake
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.ConvertBtn).setOnClickListener {
            ...
            if(Unit1.equals("Celsius") && Unit2.equals("Celsius")) {
                ...
                result.setText(((temp.multiply((9/5).toBigDecimal()).add(32.toBigDecimal())).toString()))
            }
                ...
                result.setText((((temp.subtract(273.toBigDecimal())).multiply((9/5).toBigDecimal()).add(32.toBigDecimal())).toString()))
            }
            else if(Unit1.equals("Fahrenheit") && Unit2.equals("Celsius")) {
                result.setText((temp.subtract(32.toBigDecimal()).multiply((5/9).toBigDecimal()).toString()))
            }
            else if(Unit1.equals("Fahrenheit") && Unit2.equals("kelvin")) {
                result.setText((((temp.subtract(32.toBigDecimal()).multiply((5/9).toBigDecimal()).add(273.toBigDecimal())).toString())))
            }
